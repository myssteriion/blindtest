...
class IntegrationTest extends AbstractIntegrationTest {
    ...
    @Test
    void testShortGame() throws NotFoundException, ConflictException {
        ...
        Assertions.assertEquals( 0, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        Assertions.assertEquals( scoreName1, game.getPlayers().get(0).getScore() );
        Assertions.assertEquals( scoreName2, game.getPlayers().get(1).getScore() );
        Assertions.assertEquals( scoreName3, game.getPlayers().get(2).getScore() );
        
        
        
        /********** CHOICE Round **********/
        Assertions.assertEquals( Choice.class, game.getRound().getClass() );
        Assertions.assertEquals( nbMusicPlayed, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        /********** LUCKY Round **********/
        Assertions.assertEquals( Lucky.class, game.getRound().getClass() );
        Assertions.assertEquals( nbMusicPlayed, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        /********** FRIENDSHIP Round **********/
        Assertions.assertEquals( Friendship.class, game.getRound().getClass() );
        Assertions.assertEquals( nbMusicPlayed, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        /********** THIEF Round **********/
        Assertions.assertEquals( Thief.class, game.getRound().getClass() );
        Assertions.assertEquals( nbMusicPlayed, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        Assertions.assertTrue( game.getPlayers().get(0).getScore() >= scoreName1 );
        Assertions.assertTrue( game.getPlayers().get(1).getScore() >= scoreName2 );
        Assertions.assertTrue( game.getPlayers().get(2).getScore() >= scoreName3 );
        
        
        
        /********** RECOVERY Round **********/
        Assertions.assertEquals( Recovery.class, game.getRound().getClass() );
        Assertions.assertEquals( nbMusicPlayed, game.getNbMusicsPlayed() );
        Assertions.assertEquals( 0, game.getNbMusicsPlayedInRound() );
        ...
        Assertions.assertEquals( Integer.valueOf(game.getNbMusicsPlayed()), profileStat.getListenedMusics().get(Theme.ANNEES_80) );
        Assertions.assertEquals( Integer.valueOf(foundName1), profileStat.getFoundMusics().get(Theme.ANNEES_80).get(GoodAnswer.AUTHOR) );
        Assertions.assertTrue(profileStat.getBestScores().get(duration) >= scoreName1);
        
        profileStat = profileService.find(PROFILES_LIST.get(1)).getProfileStat();
        Assertions.assertEquals( Integer.valueOf(1), profileStat.getPlayedGames().get(game.getDuration()) );
        Assertions.assertEquals( Integer.valueOf(game.getNbMusicsPlayed()), profileStat.getListenedMusics().get(Theme.ANNEES_80) );
        Assertions.assertEquals( Integer.valueOf(foundName2), profileStat.getFoundMusics().get(Theme.ANNEES_80).get(GoodAnswer.AUTHOR) );
        Assertions.assertTrue(profileStat.getBestScores().get(duration) >= scoreName2);
        
        profileStat = profileService.find(PROFILES_LIST.get(2)).getProfileStat();
        Assertions.assertEquals( Integer.valueOf(1), profileStat.getPlayedGames().get(game.getDuration()) );
        Assertions.assertEquals( Integer.valueOf(game.getNbMusicsPlayed()), profileStat.getListenedMusics().get(Theme.ANNEES_80) );
        Assertions.assertEquals( Integer.valueOf(foundName3), profileStat.getFoundMusics().get(Theme.ANNEES_80).get(GoodAnswer.AUTHOR) );
        Assertions.assertTrue(profileStat.getBestScores().get(duration) >= scoreName3);
        
        MusicEntity music = musicService.find( MUSICS_LIST.get(0) );
        Assertions.assertEquals( nbMusicPlayed, music.getPlayed() );
