...
public class GameServiceTest extends AbstractTest {
	...
	public void apply() throws NotFoundException, SpotifyException, ConflictException {
		...
		Assert.assertNull( profileStatDto.getPlayedGames().get(game.getDuration()) );
		...
		Assert.assertNull( profileStatDto1.getPlayedGames().get(game.getDuration()) );
		...
		// thief : 20 à 100pts
		// recovery : 10 à 30pts
		Assert.assertTrue( profileStatDto.getBestScores().get(Duration.NORMAL) >= new Integer(15*100 + 1*200 + 4*150 + 8*100 + 10*150 + 10*150 + 20*100 + 10*30)
						   && profileStatDto.getBestScores().get(Duration.NORMAL) <= new Integer(15*100 + 1*200 + 4*150 + 8*100 + 10*150 + 10*100 + 10*150 + 20*100 + 10*30) );
	}
