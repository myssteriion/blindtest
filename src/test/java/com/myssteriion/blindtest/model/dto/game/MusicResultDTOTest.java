...
public class MusicResultDTOTest extends AbstractTest {
    ...
    public void constructor() {
        ...
        try {
            new MusicResultDTO(null, musicDTO, null, null, null, null);
        ...
        try {
            new MusicResultDTO(gameId, null, null, null, null, null);
            Assert.fail("Doit lever une IllegalArgumentException car un champ est KO.");
        }
        catch (IllegalArgumentException e) {
        ...
        Assert.assertNotNull( new MusicResultDTO(gameId, musicDTO, null, null, null, null) );
    }
    ...
    public void getterSetter() {
        ...
        MusicResultDTO musicResultDTO = new MusicResultDTO(gameId, musicDTO, null, null, null, null);
    ...
    public void toStringAndEquals() {
        ...
        MusicDTO musicDTO = new MusicDTO("name", Theme.ANNEES_80);
        MusicResultDTO musicResultDTO = new MusicResultDTO(gameId, musicDTO, null, null, null, null);
        Assert.assertEquals( "gameId=1, musicDTO={id=null, name=name, theme=ANNEES_80, played=0}, winners=[], winnersBonus=[], neutral=[], loosers=[]", musicResultDTO.toString() );
    }
